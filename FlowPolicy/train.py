if __name__ == "__main__":
    ...
    import os
    import pathlib
    # os.environ["WANDB_API_KEY"] = "eb06ddfa0a55253b22ab652ab4aa09fb17eefe20"
        ...
        for local_epoch_idx in range(cfg.training.num_epochs):
            ...
            with tqdm.tqdm(train_dataloader, desc=f"Training epoch {self.epoch}", 
                ...
                for batch_idx, batch in enumerate(tepoch):
                    ...
                    # compute loss
                    t1_1 = time.time()
                    if local_epoch_idx<1000:
                        rectified=False
                    else:
                        rectified = True
                    raw_loss, loss_dict = self.model.compute_loss(batch,rectified=rectified)
